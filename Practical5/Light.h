...
class Light : public SmartDevice
{
    ...
    protected:
        /**
         * @brief State of the LightSensor that Light is observing.
         * 
         * This boolean value indicates whether the light sensor is activated.
         */
        bool lightSensorState;

        /**
         * @brief Pointer to the LightSensor that Light is observing.
         * 
         * This pointer is used to access the LightSensor's state and functionality.
         */
