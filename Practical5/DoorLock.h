...
class DoorLock : public SmartDevice
{
    ...
    protected:
        /**
         * @brief The state of the DoorSensor being observed.
         * 
         * Represents whether the door is open or closed, as reported by the DoorSensor.
         */
        bool doorSensorState;

        /**
         * @brief Pointer to the DoorSensor being observed.
         * 
         * This pointer allows the DoorLock to observe and react to changes in the DoorSensor's state.
         */
